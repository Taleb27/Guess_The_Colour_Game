...
public class ArrayListActivity extends AppCompatActivity  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        list.add(new Item("my first item",R.drawable.d274507,true,50));
        list.add(new Item("idk",R.drawable.d274507,true,34));
        list.add(new Item("this is supposed to be a string",R.drawable.d274507,true,74));
        list.add(new Item("weeeeee",R.drawable.d274507,true,21));

        //reference to the list view so it can be programmed
        myListView=findViewById(R.id.MyListView);

        //connect adapter with data
        myAdapter=new CustomAdapter(this,R.layout.item_raw,list);
